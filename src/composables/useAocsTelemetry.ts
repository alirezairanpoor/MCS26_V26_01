...
export type AocsTelemetryStatus =
  | 'empty'
  | 'good'
  | 'warning'
  | 'bad';
...
function wave(
  ...
  return (
    center +
    Math.sin(time / period + phase) * amplitude
  );
}
...
export function useAocsTelemetry(
  options: UseAocsTelemetryOptions
) {
  const {
    missionSeconds,
  ...
  const aocsTelemetry =
    computed<AocsTelemetryRow[]>(() => {
      ...
      const scenario1FrankfurtImaging =
        !isScenario2.value &&
        t >= 900 &&
        t <= 960;
      ...
      const frankfurtTargetTracking =
        scenario1FrankfurtImaging ||
        scenario2FrankfurtImaging;
      ...
      const aocsComputerLoad =
        imagingActive
          ? wave(t, 56, 5, 19, 0.8)
          : wave(t, 42, 6, 24, 0.8);

      const sensorProcessorTemp =
        wave(
          t,
          38.5,
          1.2,
      ...
      const nominalAltitudeKm =
        500;

      const altitudeVariationKm =
        1.2;

      const altitudePeriod =
        430;
      ...
      const assumedMomentumCapacity =
        4.0;

      const momentumMargin =
        clamp(
          100 -
          (
            storedMomentum /
            assumedMomentumCapacity
          ) *
          100,
          0,
          100
      ...
      const attitudeErrorStatus =
        attitudeControlError <= 0.10
          ? 'good'
          : attitudeControlError <= 0.30
            ? 'warning'
            : 'bad';
      ...
      return [
        ...
        telemetryRow(
          'ATT136',
          'AOCS Control Cycle Rate',
          controlCycleRate.toFixed(2),
          'Hz'
        ),
        ...
        telemetryRow(
          ...
          '%',
          starTrackerAQuality >= 90
            ? 'good'
            : starTrackerAQuality >= 75
              ? 'warning'
              : 'bad'
        ),
        ...
        telemetryRow(
          ...
          '%',
          starTrackerBQuality >= 90
            ? 'good'
            : starTrackerBQuality >= 75
              ? 'warning'
              : 'bad'
        ),
        ...
        telemetryRow(
          'SUN305',
          'Coarse Sun Sensor Active Faces',
          coarseSunFaces.toString(),
          'count'
        ),
        ...
        telemetryRow(
          'SUN314',
          'Sun Vector Magnitude',
          normalizedSunMagnitude.toFixed(6),
          '-'
        ),
        ...
        telemetryRow(
          ...
          magneticFieldMagnitude.toFixed(2),
          'µT'
        ),
        ...
        telemetryRow(
          ...
          magnetometerSampleRate.toFixed(2),
          'Hz'
        ),
        ...
        telemetryRow(
          'ORB642',
          'Position Sigma Z',
          positionSigmaZ.toFixed(2),
          'm'
        ),

        telemetryRow(
          'ORB643',
          'Velocity Solution Sigma',
          velocitySigma.toFixed(4),
          'm/s'
        ),
        ...
        telemetryRow(
          'RW703',
          'Reaction Wheel 1 Current',
          rw1Current.toFixed(3),
          'A'
        ),
        ...
        telemetryRow(
          'RW713',
          'Reaction Wheel 2 Current',
          rw2Current.toFixed(3),
          'A'
        ),
        ...
        telemetryRow(
          'RW723',
          'Reaction Wheel 3 Current',
          rw3Current.toFixed(3),
          'A'
        ),
        ...
        telemetryRow(
          'RW733',
          'Reaction Wheel 4 Current',
          rw4Current.toFixed(3),
          'A'
        ),
        ...
        telemetryRow(
          'MTQ806',
          'Magnetorquer Bus Current',
          mtqCurrent.toFixed(3),
          'A'
        ),
        ...
        telemetryRow(
          ...
          '%',
          covarianceQuality >= 90
            ? 'good'
            : covarianceQuality >= 75
              ? 'warning'
              : 'bad'
        ),
        ...
        telemetryRow(
          'ACT962',
          'Main Propulsion AOCS Interface',
          'NOT CONFIGURED',
          'state',
          'empty'
        ),
