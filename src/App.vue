<script setup lang="ts">
  ...
  const emergencyMessageText = computed(
    () =>
      `${emergencyEventCode}: Critical battery discharge detected. Request GNC approval for attitude change to improve solar array charging attitude.`
  );
      ...
      <div v-if="gncSuggestionModalVisible" class="emergency-modal-overlay">
        <div class="emergency-modal gnc-response-modal">
          ...
          <table class="emergency-table">
            <tr>
              <th>Response</th>
              <td class="status-bad blink-red">NEGATIVE</td>
            </tr>
            <tr>
              <th>Recommendation</th>
              <td class="status-warning blink-warning">
                Import the contingency procedure and continue with battery recovery.
              </td>
            </tr>
          </table>
          ...
          <div class="procedure-box full-width">
            ...
            <table class="procedure-table">
              ...
              <tr>
                <td>1</td>
                <td>SOM</td>
                <td>Start simulation and wait for GS1 Acquisition of Signal (AOS).</td>

                <td>GS1 AOS acquired<br /></td>
                <td>
                  <button
              ...
              <tr>
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to open Ground Station panel and report GS1
                  <strong>GEL005</strong> current elevation.
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    Verify downlink signal quality
                  </button>
                </td>
              ...
              <tr>
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select GS1 <strong>GSE001</strong> and execute Filter Signal.
                </td>
              ...
              <tr>
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to open Ground Station panel and verify <strong>GSE001</strong> and
                  <strong>GBL092</strong> signal filtering result.
                </td>
              ...
              <tr>
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>MEM221</strong> and execute Dump Payload Memory.
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    {{
                      isScenario2
                        ? 'Evaluate battery state-of-charge'
                        : 'Request EPS telemetry status'
                    }}
                  </button>
                </td>
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>EPT014</strong> and execute Reduce Payload Power.
                </td>
                <td>Execution time ~ 15 [s]</td>
                <td>
                  <button
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>SOM → SOE2</td>
                <td>
                  Ask SOE2 to open EPS panel and report <strong>EPT014</strong> after mitigation.
                </td>
                <td>
                ...
                <td>
                  ...
                  >
                    Request post-mitigation EPS telemetry
                  </button>
                </td>
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>
                  ...
                  >
                    Confirm EPS parameters nominal
                  </button>
                </td>
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>PWR740</strong> and execute Increase Payload
                  Power.
                </td>
                <td>
                ...
                <td>
                  ...
                  >
                    Restore payload power for imaging
                  </button>
                </td>
                <td
                  :class="
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>
                  ...
                  >
                    Configure payload imaging mode
                  </button>
                </td>
                <td
                  :class="
              ...
              <tr v-if="!isScenario2 || (isScenario2 && !scenario2NewProcedureImported)">
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to open Payload panel and verify <strong>CAM000</strong> camera
                  configuration.
                </td>
              ...
              <tr v-if="!isScenario2">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>STB901</strong> and execute Spacecraft Standby
                  Mode to save power.
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Request SPACON to select <strong>BAT330</strong> and execute Battery Equalization
                  Transfer. Battery A charge is redistributed into Battery B/C.
                </td>
                <td>
                  <div>
                    Equalize battery charge values to restore power margin. Keep emergency status
                    active until verification confirms recovery
                  </div>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE2</td>
                <td>
                  Ask SOE2 to open EPS panel and report <strong>BCH096</strong>,
                  <strong>BCH097</strong> and <strong>BCH098</strong> again after BAT330.
                </td>
                <td>
                ...
                <td>
                  ...
                  >
                    Verify battery recovery status
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to open EPS panel and report spacecraft power margin
                  <strong>NET118</strong>.
                </td>
                <td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>PSM001</strong> and execute Enter Power Saving
                  Mode.
                </td>
                <td>Execution time ~ 15 [s]</td>
                <td>
                  ...
                  >
                    Enter power-saving configuration
                  </button>
                </td>
                <td
                  :class="
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE2</td>
                <td>
                  Ask SOE2 to open EPS panel and report <strong>NET118</strong>,
                  <strong>BCH096</strong>, <strong>BCH097</strong> & <strong>BCH098</strong> again.
                </td>
                <td>
                  <div>
                    If power → <strong>NOMINAL</strong> & Battery values > <strong>20%</strong>
                  </div>
                  <div>
                    verify recovery. Battery alert downgrades from
                    <strong>EMERGENCY SITUATION</strong> to <strong>WARNING</strong>
                  </div>
                </td>
                <td>
                  <button
                  ...
                  >
                    Confirm low-power configuration active
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to open EPS panel and report the temperature/power parameters
                  <strong>EPT014</strong> and <strong>NET118</strong>.
                </td>
                <td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>
                  ...
                  >
                    Wait for GS2 acquisition window
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>
                  ...
                  >
                    Verify GS2 downlink acquisition
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SPACON</td>
                <td>
                  Command SPACON to select <strong>GSE001</strong> and execute Filter Signal for
                  GS2.
                </td>
                <td>Execution time ~ 10 [s]</td>
                <td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM</td>
                <td>
                  Compare SOE1 thermal report with the criteria. If temperature is high, request
                  SPACON thermal mitigation.
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE2</td>
                <td>
                  Ask SOE2 to open EPS panel and report <strong>EPT014</strong> temperature after
                  mitigation.
                </td>
                ...
                <td>
                  <button
                    ...
                    :class="{ actionFail: failedSomAction === 'askEpsAfter' }"
                  >
                    Request post-mitigation thermal telemetry
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>
                  <div>
                    <strong>CAUTION:</strong> EPS temperature may rise after increasing payload
                    power
                  </div>
                ...
                <td>
                  <button
                    ...
                    :class="{ actionFail: failedSomAction === 'confirmEps' }"
                  >
                    Confirm EPS and thermal parameters within limits
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>
                  ...
                  >
                    Restore payload power for imaging window
                  </button>
                </td>
                <td
                  :class="
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE1</td>
                <td>
                  Ask SOE1 to verify camera configuration using Payload/<strong>CAM201</strong> and
                  <strong>PLD620</strong>.
                </td>
                <td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>SOM → SOE2</td>
                <td>
                  Ask SOE2 to report thermal values <strong>EPT014</strong> &
                  <strong>DCC208</strong> after payload power increase.
                </td>
                ...
                <td>
                  ...
                  >
                    Report post-restoration thermal trend
                  </button>
                </td>
              ...
              <tr v-if="isScenario2 && scenario2NewProcedureImported">
                ...
                <td>
                  ...
                  >
                    Execute image acquisition during imaging window
                  </button>
                </td>
                <td
                  :class="
      ...
      <div class="emergency-modal emergency-step-modal">
        ...
        <div v-if="emergencyStep === 'summary'" key="summary" class="emergency-step-panel">
          <table class="emergency-table">
            ...
            <tr>
              <th>Status</th>
              <td class="status-bad blink-red">EMERGENCY SITUATION</td>
            </tr>
            <tr>
              <th>Trigger</th>
            ...
            <tr>
              ...
              <td>Contact external subsystem authority before importing contingency procedure.</td>
            </tr>
          </table>
        ...
        <div v-else-if="emergencyStep === 'waiting'" key="waiting" class="emergency-step-panel">
          <div class="gnc-waiting-response emergency-waiting-only">
            ...
            <div class="gnc-waiting-title">WAITING FOR RESPONSE</div>

            <div class="gnc-waiting-subtitle">GNC ANALYSIS IN PROGRESS</div>
          </div>
        </div>
      </div>
    </div>
